...
gdjs.GameOverCode.asyncCallback18042956 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GameOverCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Select_Level", false);
}
gdjs.GameOverCode.localVariables.length = 0;
}
gdjs.GameOverCode.idToCallbackMap.set(18042956, gdjs.GameOverCode.asyncCallback18042956);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.2), (runtimeScene) => (gdjs.GameOverCode.asyncCallback18042956(runtimeScene, asyncObjectsList)), 18042956, asyncObjectsList);
}
}
